...
if st.session_state.step == 1:
    ...
    q3 = st.radio("", [
        ...
        "ก็เริ่มจะใจสั่นๆ เวลาเห็นแจ้งเตือนเทอแล้วนะ", 
        "ขอเก็บไว้ลุ้นต่ออีกนิด แต่คะแนนนำโด่งเลยล่ะ",
        "มากกว่ามีใจ... คืออยากมีเทออยู่ข้างๆ แล้วครับ"
    ])
    ...
    q2 = st.radio("", [
        ...
        "ทุกข้อที่กล่าวมาครับ อยู่ที่ว่าเทอจะตกลงเมื่อไหร่"
    ])
    ...
    <div style='text-align: center; color: #590d22;'>
        ...
        <h2 style='color: #ff4d6d;'>Happy Valentine’s Day! จุ๊บๆ ❤️</h2>
    </div>
    """, unsafe_allow_html=True)
